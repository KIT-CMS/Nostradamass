...
def loss_fully_hadronic(y_true, y_pred):
    ...
    dx = (K.square(y_pred[:,i_inv1_px] - y_true[:,i_inv1_px])/gen_mass) + (K.square(y_pred[:,i_inv2_px] - y_true[:,i_inv2_px])/gen_mass) + (K.square(y_pred[:,i_smear_px] - y_true[:,i_smear_px])/gen_mass)
    dy = (K.square(y_pred[:,i_inv1_py] - y_true[:,i_inv1_py])/gen_mass) + (K.square(y_pred[:,i_inv2_py] - y_true[:,i_inv2_py])/gen_mass) + (K.square(y_pred[:,i_smear_py] - y_true[:,i_smear_py])/gen_mass)
    ...
    dm_tau_1 = K.square((K.square(y_true[:,i_tau1_e] + K.sqrt( K.square(y_pred[:,i_inv1_px]) + K.square(y_pred[:,i_inv1_py]) + K.square(y_pred[:,i_inv1_pz]))) -
                     ( K.square(y_true[:,i_tau1_px] + y_pred[:,i_inv1_px]) + K.square(y_true[:,i_tau1_py] + y_pred[:,i_inv1_py]) + K.square(y_true[:,i_tau1_pz] + y_pred[:,i_inv1_pz])) -
                       mtau_squared)/gen_mass)

    dm_tau_2 = K.square((K.square(y_true[:,i_tau2_e] + K.sqrt( K.square(y_pred[:,i_inv2_px]) + K.square(y_pred[:,i_inv2_py]) + K.square(y_pred[:,i_inv2_pz]))) -
                     ( K.square(y_true[:,i_tau2_px] + y_pred[:,i_inv2_px]) + K.square(y_true[:,i_tau2_py] + y_pred[:,i_inv2_py]) + K.square(y_true[:,i_tau2_pz] + y_pred[:,i_inv2_pz])) -
                       mtau_squared)/gen_mass)
